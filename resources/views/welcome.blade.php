...
<body>
    <section>
        <nav class="bg-white border-gray-200 px-2">
            <div class="container mx-auto flex flex-wrap items-center justify-between">
                ...
                <div class="hidden md:block w-full md:w-auto navbar-start" id="mobile-menu">
    ...
    <section>
        ...
        <br />
        <div class="container md:container md:mx-auto flex flex-row w-100 content-evenly  ">
            <a>
                <img src="{{ asset('images/cta1-athletic.jpg')}}" alt="">
                <h2 class="realtive">WHAT'S NEW</h2>
            </a>
            <a>
                <img src="{{ asset('images/cta2-athletic2.jpg')}}">
            </a>
            <a>
                <img src="{{ asset('images/cta3-athletic.jpg')}}">
            </a>
            <a>
                <img src="{{ asset('images/cta4-athletic.jpg')}}">
            </a>
        </div>
    </section>
    ...
    <section>
        ...
        <div class="container md:container md:mx-auto flex flex-row w-100 content-evenly  ">
            <a>
                <img src="{{ asset('images/windbreaker.jpg')}}" alt="">
                <h3 class="realtive">WINDBREAKER IN BLACK</h3>
                <h3 class="realtive">MaVaZi</h3>
                <h3 class="realtive">kSH 249.95</h3>
            </a>
            <a>
                <img src="{{ asset('images/leggings.jpg')}}">
                <h3 class="realtive">WINDBREAKER IN BLACK</h3>
                <h3 class="realtive">MaVaZi</h3>
                <h3 class="realtive">kSH 249.95</h3>
            </a>
            <a>
                <img src="{{ asset('images/tank.jpg')}}">
                <h3 class="realtive">WINDBREAKER IN BLACK</h3>
                <h3 class="realtive">MaVaZi</h3>
                <h3 class="realtive">kSH 249.95</h3>
            </a>
            <a>
                <img src="{{ asset('images/shorts.jpg')}}">
                <h3 class="realtive">WINDBREAKER IN BLACK</h3>
                <h3 class="realtive">MaVaZi</h3>
                <h3 class="realtive">kSH 249.95</h3>
            </a>
        ...
        <div id="carouselExampleCaptions" class="carousel slide relative" data-bs-ride="carousel">
            ...
            <div class="carousel-inner relative w-full overflow-hidden">
                <div class="carousel-item active relative float-left w-full">
                    <img src="{{ asset('images/intro.jpg')}}" class="block w-full" alt="..." />
